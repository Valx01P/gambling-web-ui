// Default code shown to a user creating a fresh bot. Lives in its own
// module so the heavy JsCodeEditor component can be dynamically loaded
// without dragging this ~25KB template along into the route bundle —
// the page itself still needs STARTER_CODE eagerly to populate the draft
// when a brand-new bot is opened.
